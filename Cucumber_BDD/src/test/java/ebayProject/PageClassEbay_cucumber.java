...
public class PageClassEbay_cucumber {
	WebDriver d;
	WebDriverWait wait;

	public PageClassEbay_cucumber(WebDriver d) {
		this.d = d;
...
//		d.findElement(remove).click();
	...
	By delete=By.xpath("//*[@id=\"mainContent\"]/div/div[3]/div[1]/div[1]/div[1]/ul/li/div[1]/div/div[2]/div[2]/span[3]/button");
	...
	public void changeadress() throws InterruptedException {
		...
		userAdress.click();
		userAdress.clear();
		userAdress.sendKeys("Visakhapatnam");
	...
	public void selbyall() throws InterruptedException {
		...
		for (int i = 0; i < 15; i++) {
		    ((JavascriptExecutor) d).executeScript("window.scrollBy(0, 3000);");
		    Thread.sleep(1000);
		}
	}
	...
	//By contry=By.className("custom-country-select__placeholder css-1wa3eu0-placeholder");
	//By con=By.cssSelector("div[class=\"custom-country-select__placeholder css-1wa3eu0-placeholder\"]");
	//By conty=By.cssSelector("div[class=\"custom-country-select__value-container css-1hwfws3\"]");
	...
	public void chnglanguage() throws InterruptedException {
		...
		Actions a = new Actions(d);////*[@id="__next"]/div[2]/div[2]/div[1]/form/div/div[2]/div/div[2]/div/svg
		Thread.sleep(5000);
...
//		//WebElement sel=d.findElement(con);
//		sel.click();
//		Thread.sleep(3000);
		//sel.sendKeys("India");
...
//		sel.sendKeys(Keys.ENTER);
	...
	By outt=By.xpath("//*[@id=\"s0-1-4-9-3[0]-0-9-dialog\"]/div/div/ul/li[3]/a");
	public void signout() throws InterruptedException {
		...
		a.moveToElement(change).perform();
		Thread.sleep(4000);
		d.findElement(outt).click();
	}
	
	By logo = By.id("gh-logo");
	public void scrollbyend() throws InterruptedException {
		WebElement search = d.findElement(logo);
		search.click();
		Thread.sleep(1000);
		for (int i = 0; i < 8; i++) {
		    ((JavascriptExecutor) d).executeScript("window.scrollBy(0, 500);");
